...
export default function Section({
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-28 animate-fadeUp">
      ...
      <div className="text-white/80 text-sm md:text-lg leading-relaxed bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-3xl p-4 md:p-8 shadow-2xl border border-white/20 font-inter hover:animate-glow transition-all duration-500">
        {children}
      </div>
    </section>
  )
